                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item text-nowrap ms-3">
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button class="nav-link px-3 border-0" type="submit">Back</button>
                                </form>
                            </li>
                        </ul>
                    </div>
        ...
        <main class="mt-4">
            <div class="container-fluid">
                ...
                <!-- <div class="text-center">
                        <img src="{{ asset('assets/app-img/home01.jpg') }}" class="img-fluid" width="350" alt="Hotel Image 01">
                    </div> -->
                @endif
